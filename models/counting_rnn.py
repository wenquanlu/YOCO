...
class CountingRNN(nn.Module):
    ...
    def compute_loss(self, predicted_heatmaps, heatmaps, predicted_coords, seq_lens, max_seq_len, alpha=0.1):
        """
        ...
        heatmap_mask = heatmap_mask.unsqueeze(-1).unsqueeze(-1) # (batch, max_seq_len, 1, 1)
